...
export function DeleteConfirmModal() {
  ...
  return (
    ...
    >
      <div className="bg-card p-8 rounded-2xl shadow-xl text-center w-full max-w-md mx-4">
        ...
        <p className="text-muted-foreground mb-6">이 작업은 되돌릴 수 없습니다.</p>
        <div className="flex justify-center space-x-4">
          <button
            onClick={closeDeleteModal}
            className="px-6 py-2 border rounded-lg hover:bg-secondary transition-colors font-semibold"
          >
            취소
          </button>
          <button
            onClick={handleDeleteAndRefresh}
            className="px-6 py-2 bg-red-600 text-primary-foreground rounded-lg hover:bg-red-700 transition-colors font-semibold"
          >
            삭제 확인
          </button>
        </div>
