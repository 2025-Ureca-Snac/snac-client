  ...
  return (
    <div className="flex flex-col gap-3 mt-6">
      ...
      <button
        ...
        className="w-full py-4 rounded-lg bg-secondary text-foreground font-bold text-lg hover:bg-muted transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        aria-label="회원 탈퇴"
      >
        탈퇴하기
      </button>
