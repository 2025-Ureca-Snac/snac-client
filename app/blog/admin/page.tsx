    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="bg-card rounded-lg shadow-light p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
                    required
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-muted file:text-foreground hover:file:bg-secondary"
                    accept="image/*"
                    required={!editId}
                  />
              ...
              <div>
                ...
                {previewMode ? (
                  <div className="prose max-w-none border border-border rounded-md p-4 bg-muted min-h-[400px]">
                    <MarkdownRenderer
              ...
              <div className="flex justify-end space-x-4 pt-4 border-t">
                <button
                  type="button"
                  onClick={handleReset}
                  className="px-6 py-2 border border-border text-foreground rounded-md hover:bg-muted focus:outline-none focus:ring-2 focus:ring-gray-500"
                >
                  초기화
                </button>
                <button
                  type="submit"
                  className="px-6 py-2 bg-muted text-primary-foreground rounded-md hover:bg-muted focus:outline-none focus:ring-2 focus:ring-gray-500"
                >
...
export default function BlogAdminPage() {
  const loadingFallback = (
    <div className="min-h-screen flex items-center justify-center">
      <div className="animate-spin w-12 h-12 border-4 border-gray-400 border-t-transparent rounded-full" />
      <span className="ml-4 text-muted-foreground text-lg">페이지 로딩 중...</span>
    </div>
  );
