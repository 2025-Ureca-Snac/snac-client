      ...
      <div className="relative p-8">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center py-4 border-b border-border/50">
            ...
            <span className="font-mono text-lg text-primary-foreground bg-muted/50 px-3 py-1 rounded-lg">
              #{tradeId}
            </span>
          </div>

          <div className="flex justify-between items-center py-4 border-b border-border/50">
            <span className="text-muted-foreground">상대방 닉네임</span>
            <span className="font-medium text-primary-foreground">{partner.name}</span>
          </div>

          <div className="flex justify-between items-center py-4 border-b border-border/50">
            <span className="text-muted-foreground">통신사</span>
            <span className="font-medium text-primary-foreground">{partner.carrier}</span>
          </div>

          <div className="flex justify-between items-center py-4 border-b border-border/50">
            <span className="text-muted-foreground">전송량</span>
            <span className="font-medium text-primary-foreground">{partner.data}GB</span>
          </div>
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <span className="font-medium text-primary-foreground">{completedAt}</span>
          </div>
        </div>
