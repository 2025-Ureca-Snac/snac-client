      ...
      <div className="relative bg-card/30 backdrop-blur-sm rounded-2xl border border-border/50 shadow-2xl overflow-hidden">
        ...
        <div className="relative p-8">
          <div className="text-center">
            ...
            <button
              onClick={onNext}
              className="w-full bg-gradient-to-r from-green-400 to-green-500 text-card-foreground py-4 px-6 rounded-xl font-bold hover:from-green-300 hover:to-green-400 transition-all duration-300 shadow-lg hover:shadow-green-400/25 relative overflow-hidden group"
            >
