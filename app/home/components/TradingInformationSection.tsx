    ...
    <section className="bg-card  h-full md:h-[532px] justify-center flex w-full md:full  ">
      <div className=" w-full gap-8 md:gap-0 flex-col-reverse flex flex-col md:flex-row items-center px-6 md:px-20 lg:pl-44 py-10">
        ...
        <div className="w-full md:w-2/3 flex flex-col gap-4">
          <h2 className="text-card-foreground text-2xl md:text-3xl font-bold mb-2">
            천천히, 안전하게 데이터 거래
          </h2>
          ...
          <Link
            href="/cards"
            className="mt-6 w-full md:w-[430px] border-2 border-border inline-block rounded-xl bg-primary text-primary-foreground font-semibold text-center py-3 px-8 shadow hover:bg-primary/90 transition"
          >
            일반거래 시작하기
          </Link>
        </div>
